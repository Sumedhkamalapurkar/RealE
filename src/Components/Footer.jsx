    ...
    <footer className="relative w-full">
      <div className="mx-auto w-full max-w-7xl px-8 bg-black text-white ">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <Typography variant="h5" className="mb-6 text-2xl flex justify-center mt-5">
            Real Estate
          </Typography>
                ...
                {items.map((link) => (
                  <li key={link}>
                    <Typography
                      ...
                      className="py-1.5 font-normal text-sm transition-colors opacity-70 hover:text-blue-gray-200"
                    >
                      {link}
                    </Typography>
                  </li>
