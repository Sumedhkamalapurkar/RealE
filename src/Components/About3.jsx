...
<div>
      <div className="relative max-h-[350px] overflow-hidden flex justify-center items-center h-[250px]">
        <img src={aboutbg3} alt="about" className="w-full h-full absolute object-cover align-middle overflow-clip "/>
        <div className="relative">
          <h1 className="text-[#fff] text-6xl font-bold text-center ">ABOUT US</h1>
      ...
      <div id="aboutUs" className="w-full">
        <div className="flex flex-wrap flex-row px-20 w-full gap-5 pt-8 pb-8  bg-[rgba(238,238,238,0.66)]">
          <div className="w-[350px] md-w-1/3 md:float-left">
            <h1 className="text-2xl text-[#353535] font-semibold pb-3">OUR FAVORITE QUOTE</h1>
          ...
          <div className="float-right w-[740px] text-[#353535]">
            ...
            <div className="text-base">
              <span>
                At Real Estate, our team is highly motivated,
...
<div className="px-20 text-center py-8 ">
  ...
  <div className="flex justify-center">
    <span className="text-base text-[#353535] md:w-[600px]">At Real Estate, it's our goal to not only have a positive effect on ourselves and our families - but also to inspire, motivate, and create lasting change in everyone we encounter</span>
  </div>
</div>

   <div className="relative py-4">
   {/* <img src={aboutbg4} alt="aboutbg" className="w-full h-full absolute object-cover"/>  */}
<div className=" md:flex flex-row px-20 justify-center gap-4 text-center overflow-clip bg-gray-100 text-[#353535] relative p-10">
  <div className="md:w-1/3  ">
<h1 className="text-[24px] pb-7 font-semibold">COMMUNITY REJUVENATION</h1>
    <p className="text-base pb-4 font-medium">We aim to rejuvenate neighborhoods and increase the standard of living by improving the overall quality of housing for the residents</p>
  </div>
  <div className="md:w-1/3 ">
    <h1 className="text-[24px] pb-4 md:pb-2 font-semibold ">SOLUTIONS & SYSTEMS ORIENTED</h1>
    <p className="text-base pb-4 font-medium">Our core business lies within our systems, education and knowledge of the real estate industry</p>
  </div>
  <div className="md:w-1/3">
    <h1 className="text-[24px] pb-7 font-semibold">TEAM APPROACH</h1>
    <p className="text-base font-medium">We have an aggressive team approach, and a top-notch ability to expand our client base through our knowledge of deal structuring and advanced real estate techniques</p>
  </div>
</div>
</div> 
...
<div className="px-20 text-center py-14 ">
  <div className="pb-4">
    <h1 className="text-2xl text-[rgb(53,53,53)] font-semibold">WHY CHOOSE US</h1>
    </div>
    
  <div className="flex justify-center">
    <span className="text-base text-[#353535] md:w-[600px]">Real Estate is committed to rejuvenating Space Coast communities through our systematic and disciplined approach, and creating lasting change in every neighborhood we encounter.</span>
  </div>
</div>

<section id='testimonial' className='flex w-full my-auto justify-center text-center items-center p-10 mb-10'>
        ...
        {Data.map((item, index) => index === current && <div key={index}>
            <h1  className='pb-6 text-4xl flex justify-center'>Testimonials</h1>
            <div>
          ...
          <div className='flex pb-4 items-center'>  
                <div>
                <button type='button' className='bg-gray-200 p-2 mr-4 hover:bg-gray-300' onClick={previous}>
                    <i class="fa-solid fa-arrow-left"></i>
                    </button>   
                </div>
            <div>
            <span className='text-xl mr-1'><i class="fa-solid fa-quote-left"></i></span>
              <span >{item.text_content}</span>
              </div>
                <div>  <button onClick={next} className='bg-gray-200 p-2 ml-4 hover:bg-gray-300' type='button'>
